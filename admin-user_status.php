      ...
      <div class="row">
        <div class="col-md-12" style="">
          ...
          <div class="tab-content mt-2">
			...
			<?php
			$q="SELECT t.*,u.* FROM ticket t,user u WHERE t.user_id=u.user_id AND t.zone='A1'";
			if($result=$mysqli->query($q)){
			echo '<table>';
			echo "<tr><th width='200px'>Name</th><th width='200px'>Email</th><th width='200px'>Booking date</th><th width='200px'>Time</th><th width='200px'>Quantity</th><th width='200px'>Total price</th></tr>";
            ...
            <div class="tab-pane fade" id="tabtwo" role="tabpanel">
              <?php
			$q="SELECT t.*,u.* FROM ticket t,user u WHERE t.user_id=u.user_id AND t.zone='A2'";
			if($result=$mysqli->query($q)){
			echo '<table>';
			echo "<tr><th width='200px'>Name</th><th width='200px'>Email</th><th width='200px'>Booking date</th><th width='200px'>Time</th><th width='200px'>Quantity</th><th width='200px'>Total price</th></tr>";
				while($row=$result->fetch_array()){
            ...
            <div class="tab-pane fade" id="tabthree" role="tabpanel">
              <?php
			$q="SELECT t.*,u.* FROM ticket t,user u WHERE t.user_id=u.user_id AND t.zone='B'";
			if($result=$mysqli->query($q)){
			echo '<table>';
			echo "<tr><th width='200px'>Name</th><th width='200px'>Email</th><th width='200px'>Booking date</th><th width='200px'>Time</th><th width='200px'>Quantity</th><th width='200px'>Total price</th></tr>";
				while($row=$result->fetch_array()){
			...
			<div class="tab-pane fade" id="tabfour" role="tabpanel">
              <?php
			$q="SELECT t.*,u.* FROM ticket t,user u WHERE t.user_id=u.user_id AND t.zone='C'";
			if($result=$mysqli->query($q)){
			echo '<table>';
			echo "<tr><th width='200px'>Name</th><th width='200px'>Email</th><th width='200px'>Booking date</th><th width='200px'>Time</th><th width='200px'>Quantity</th><th width='200px'>Total price</th></tr>";
				while($row=$result->fetch_array()){
